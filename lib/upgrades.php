...
/**
 * Legacy upgrade kept for reference; superseded by Elgg\Upgrade\Batch in Elgg 4+.
 *
 * @return void
 */
function hypefolders_upgrade_20160510a() {
	...
	foreach ($folders as $folder) {
		...
		foreach ($resources as $resource) {
			...
			$annotations = elgg_get_annotations(['guids' => $resource->guid, 'annotation_names' => ['parent', 'weight'], 'annotation_owner_guids' => $folder->guid, 'limit' => 0]);
