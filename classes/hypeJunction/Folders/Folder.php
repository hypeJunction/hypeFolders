...
/**
 * Folder entity — a child container for resources, tied to a MainFolder.
 */
class Folder extends \ElggObject {
	 ...
	 *
	 * @param MainFolder $folder Parent folder
	 * @return void
	 */
	...
	public function getMainFolder() {
		...
		if (!$folder) {
			$folders = elgg_get_entities(['types' => 'object', 'subtypes' => MainFolder::SUBTYPE, 'relationship' => 'resource', 'relationship_guid' => $this->guid, 'inverse_relationship' => false, 'limit' => 1]);
